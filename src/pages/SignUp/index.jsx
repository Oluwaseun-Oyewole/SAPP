...
{error && (
 ...
 <div className="font-thin">{errorMessage}</div>
            ...
            <form onSubmit={submit} >
                ...
                <InputField placeholder="doe"  type="text" name="last_name" required={true}  onChange={handleChange}  icon={userIcon} value={formState.last_name}/>
                    </div>
                </div>
                <div className="mb">
                ...
                <InputField placeholder="**********" type={show ? "text":"password"} name="password" required={true} onChange={handleChange} icon={openEye} onToggle={togglePassword} value={formState.password} />
                </div>

                <div className="lg:w-1/2 w-full mr-3">
                    <label htmlFor=""> Confirm Password</label>
                <InputField placeholder="**********" type={show2 ? "text":"password"} name="confirm_password" required={true} onChange={handleChange} icon={openEye} onToggle={togglePassword2} value={formState.confirm_password} />
               </div>
                </div>
